...
//szukam sekcji i w tej sekcji renderuję
const sectionTag = document.querySelector("section")
sectionTag.appendChild(renderer.domElement)


//ustawiam scenę i kamerę w pespektywie
const scene = new THREE.Scene()

const camera = new THREE.PerspectiveCamera(50, window.innerWidth / window.innerHeight, 0.1, 10000)
camera.position.z = -899

//dodaje globalne światło do sceny

const ambientLight = new THREE.AmbientLight(0xcccccc)
scene.add(ambientLight)

//dodaje światło kierunkowe
...
//dodaje loader formatru mtl dla ziemi i obj
...
//dodaje oczy dla kota

const addEye = function () {
  const loader = new THREE.TextureLoader()
  const texture = loader.load("catseye.png")
...
const animate = function () {
  ...
  camera.lookAt(scene.position)  // dodaje to,aby kamera patrzyła na scenę
  renderer.render(scene, camera)  // //renderuję scenę i kamerę
...
//dodaję event, który odpowiada ze resize okna i kamery
